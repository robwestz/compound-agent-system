...
const required = [
  ...
  "assets/system-files/.agents/event-log.mjs",
  ...
  "assets/system-files/schemas/event-log.v1.json",
  "assets/system-files/tests/handoff-bridge.test.mjs",
  "assets/system-files/tests/event-log.test.mjs",
  ...
  "assets/system-files/.agents/eval-loop.mjs",
  "assets/system-files/.agents/idea-intake.mjs",
  "assets/system-files/.agents/role-plan.mjs",
  "assets/system-files/.agents/session-readiness.mjs",
  "assets/system-files/.agents/support-bundle.mjs",
  ...
  "assets/system-files/fixtures/planning-quality/red-team/generic-two-phase-plan.md",
  "assets/system-files/fixtures/planning-quality/red-team/missing-blocker-metadata.md",
  "assets/system-files/fixtures/planning-quality/red-team/missing-dod.md",
  "assets/system-files/fixtures/planning-quality/red-team/missing-first-vertical-slice.md",
  "assets/system-files/fixtures/planning-quality/red-team/missing-question-buckets.md",
  "assets/system-files/fixtures/planning-quality/red-team/role-mismatch.md",
  "assets/system-files/fixtures/planning-quality/red-team/thin-phase-goal.md",
  "assets/system-files/fixtures/planning-quality/red-team/unsafe-default.md",
  "assets/system-files/fixtures/planning-quality/red-team/unimportable-markers.md",
  "assets/system-files/fixtures/planning-quality/red-team/unresolved-placeholder.md",
  "assets/system-files/tests/check-output-quality.test.mjs",
  "assets/system-files/tests/check-planning-quality.test.mjs",
  "assets/system-files/tests/eval-loop.test.mjs",
  "assets/system-files/tests/idea-intake.test.mjs",
  "assets/system-files/tests/role-plan.test.mjs",
  ...
  "assets/system-files/tests/performance-scale.test.mjs",
  "assets/system-files/tests/release-readiness.test.mjs",
  "assets/system-files/tests/backward-compatibility.test.mjs",
  "assets/system-files/tests/commercial-acceptance.test.mjs",
  "assets/system-files/docs/install.md",
  "assets/system-files/docs/first-run.md",
  "assets/system-files/docs/concepts.md",
  "assets/system-files/docs/operations.md",
  "assets/system-files/docs/development.md",
  "assets/system-files/docs/release.md",
  "assets/system-files/docs/performance-and-scale-limits.md",
  "assets/system-files/docs/marketplace-release-readiness.md",
  "assets/system-files/docs/backward-compatibility-contract.md",
