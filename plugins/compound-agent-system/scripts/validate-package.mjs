...
const required = [
  ...
  "assets/system-files/fixtures/planning-quality/duplicate-phase-goal.md",
  "assets/system-files/fixtures/planning-quality/duplicate-phase-id.md",
  "assets/system-files/fixtures/planning-quality/duplicate-planning-section.md",
  "assets/system-files/fixtures/planning-quality/frontmatter-marker-mismatch.md",
  "assets/system-files/fixtures/planning-quality/generic-two-phase-plan.md",
  "assets/system-files/fixtures/planning-quality/missing-blocker-priority.md",
  "assets/system-files/fixtures/planning-quality/missing-blocker-proceed-policy.md",
  "assets/system-files/fixtures/planning-quality/missing-blocker-recommended-default.md",
  "assets/system-files/fixtures/planning-quality/missing-blocker-reversibility.md",
  "assets/system-files/fixtures/planning-quality/missing-blocker-unlock-condition.md",
  "assets/system-files/fixtures/planning-quality/missing-phase-dod.md",
  "assets/system-files/fixtures/planning-quality/missing-role-ownership.md",
  "assets/system-files/fixtures/planning-quality/role-owner-mismatch.md",
  "assets/system-files/fixtures/planning-quality/unimportable-phase-marker.md",
  "assets/system-files/fixtures/planning-quality/unsafe-external-api-default.md",
