...
[COMPOUND-PHASE id=phase-2-repeat-goal goal="Build the scoped CLI planning proof" dod="artifact:docs/verification.md" skills="reviewer"]

- machine-field: first_vertical_slice

## Closing

This fixture repeats a phase goal under a different id.
